...
class TestNearbyTool:
    ...
    def test_nearby_finds_similar_memories(self, server: SpatialMemoryServer) -> None:
        ...
        assert any("kubernetes" in c.lower() or "container" in c.lower() for c in neighbor_contents)
...
class TestForgetTool:
    ...
    def test_forget_deletes_memory(self, server: SpatialMemoryServer) -> None:
        ...
        # Store a memory
        remember_result = server._handle_tool(
            "remember",
            {
        ...
        # Delete it
        forget_result = server._handle_tool(
            "forget",
            {
                "memory_id": memory_id,
            },
...
class TestEndToEndWorkflow:
    ...
    def test_full_memory_lifecycle(self, server: SpatialMemoryServer) -> None:
        ...
        recall_result = server._handle_tool(
            "recall",
            {
        ...
        nearby_result = server._handle_tool(
            "nearby",
            {
                "memory_id": mem1["id"],
                "limit": 5,
